...
function PlayerComponent({ fileName, audioSrc, delay }) {
    ...
    const pdfSrc = "https://www.orimi.com/pdf-test.pdf"; // Different online PDF file URL
    ...
    return (
        ...
        >
            <div className="text-sm flex font-medium mb-1 opacity-70">
                    ...
                    <div className="flex items-center mt-2">
                        <button onClick={togglePlayPause} className="mr-2">
                            {isPlaying ? (
                                ...
                                >
                                    <path
                                        d="M3.5 1.5H5.5V13.5H3.5V1.5ZM9.5 1.5H11.5V13.5H9.5V1.5Z"
                                        fill="currentColor"
                                    />
                                </svg>
                            ) : (
